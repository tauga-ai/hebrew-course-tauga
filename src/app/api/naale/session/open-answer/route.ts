...
export async function POST(req: NextRequest) {
  ...
  // Milestone check: this student's most recent graded answers across every
  // AI-graded topic (not just this one), including the one just inserted —
  // see fetchRecentGradedAnswersMilestone() for the merge/placement-exclusion
  // reasoning (naale-debate-module: extracted here so naale_debate_answers,
  // and later naale_roleplay_answers, don't each need their own copy).
