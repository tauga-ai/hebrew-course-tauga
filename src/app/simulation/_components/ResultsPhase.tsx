  ...
  return (
    <div className="min-h-screen p-4 max-w-2xl mx-auto pb-12">
      <div className="text-center mt-6 mb-6">
        ...
        <h1 className="text-2xl font-bold text-primary-700 dark:text-primary-400">סיימת את הסימולציה!</h1>
      ...
      <div className="grid grid-cols-2 gap-3 mb-5">
        <div className="bg-primary-50 dark:bg-primary-500/10 border border-primary-200 dark:border-primary-800 rounded-2xl p-4 text-center">
          ...
          <div className="text-xs text-primary-600 dark:text-primary-400 mt-1">הבנת הנקרא (א+ב)<br/>{readingCorrect}/{readingTotal}</div>
        </div>
        <div className="bg-purple-50 dark:bg-purple-500/10 border border-purple-200 dark:border-purple-800 rounded-2xl p-4 text-center">
          ...
          <div className="text-xs text-purple-600 dark:text-purple-400 mt-1">בניית משפטים (ממוצע)</div>
        </div>
        <div className="bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-800 rounded-2xl p-4 text-center">
          ...
          <div className="text-xs text-green-600 dark:text-green-400 mt-1">חלק א: שאלות קשות<br/>{results.part_a.correct}/{results.part_a.total}</div>
        </div>
        <div className="bg-orange-50 dark:bg-orange-950/40 border border-orange-200 dark:border-orange-800 rounded-2xl p-4 text-center">
          ...
          <div className="text-xs text-orange-600 dark:text-orange-400 mt-1">חלק ב: שאלות קשות מאוד<br/>{results.part_b.correct}/{results.part_b.total}</div>
        </div>
      </div>
