  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-md max-w-md w-full p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-primary-700 mb-2">חלק ד — ראיון אישי</h2>
        ...
        <div className="flex justify-between items-center mb-3">
          ...
          {interviewSpeech.supported && (
            <button onClick={() => interviewSpeech.isListening ? interviewSpeech.stop() : interviewSpeech.start(currentAnswer)}
              className={`text-sm px-3 py-1.5 rounded-lg font-medium ${interviewSpeech.isListening ? 'bg-red-500 text-white animate-pulse' : 'bg-primary-100 text-primary-700 hover:bg-primary-200'}`}>
