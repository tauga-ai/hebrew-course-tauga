  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-surface rounded-2xl shadow-md w-full max-w-sm p-8">
        <h1 className="text-2xl font-bold text-center text-primary-700 dark:text-primary-400 mb-2">שכחת סיסמה?</h1>
        <p className="text-center text-fg/60 mb-8 text-sm">נשלח לך לינק לאיפוס במייל</p>
